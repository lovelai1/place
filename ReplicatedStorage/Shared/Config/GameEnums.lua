...
GameEnums.ResourceType = { Mana = "Mana" :: ResourceType, Rage = "Rage" :: ResourceType, Energy = "Energy" :: ResourceType, HolyPower = "HolyPower" :: ResourceType, Focus = "Focus" :: ResourceType, SoulEnergy = "SoulEnergy" :: ResourceType, BoneRage = "BoneRage" :: ResourceType, RunePower = "RunePower" :: ResourceType }
